 ...
 */
public class EssentialWorker extends IdxWorker
{
    /** */
    private static final long serialVersionUID = 20211001L;

    /**
     * Create a Essential Worker with a number of basic properties, including the work location type and work location that the
     * worker goes to. The init() method has to be called after the worker has been created to make sure the disease state
     * machine is started for the person if needed. The week pattern starts at day 0 and activity index 0.
     ...
     */
    public EssentialWorker(final MedlabsModelInterface model, final int id, final boolean genderFemale, final byte age,
