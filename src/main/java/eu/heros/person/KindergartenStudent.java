 ...
 */
public class KindergartenStudent extends IdxStudent
{
    /** */
     ...
     */
    public KindergartenStudent(final MedlabsModelInterface model, final int id, final boolean genderFemale, final byte age,
