...
/**
 * Worker who travels from a satellite to the central city.
 * <p>
 ...
 */
public class WorkerSatelliteToCity extends IdxWorker
{
    /** */
     ...
     */
    public WorkerSatelliteToCity(final MedlabsModelInterface model, final int id, final boolean genderFemale, final byte age,
