 ...
 */
public class CollegeStudent extends IdxStudent
{
    /** */
     ...
     */
    public CollegeStudent(final MedlabsModelInterface model, final int id, final boolean genderFemale, final byte age,
