 ...
 */
public class WorkerCountryToCity extends IdxWorker
{
    /** */
     ...
     */
    public WorkerCountryToCity(final MedlabsModelInterface model, final int id, final boolean genderFemale, final byte age,
