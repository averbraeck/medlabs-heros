 ...
 */
public class WeekendWorker extends IdxWorker
{
    /** */
    private static final long serialVersionUID = 20211001L;

    /**
     * Create a Weekend Worker with a number of basic properties, including the work location type and work location that the
