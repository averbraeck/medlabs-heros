...
/**
 * Worker who travels from the central city to a satellite for work.
 * <p>
 ...
 */
public class WorkerCityToSatellite extends IdxWorker
{
    /** */
     ...
     */
    public WorkerCityToSatellite(final MedlabsModelInterface model, final int id, final boolean genderFemale, final byte age,
