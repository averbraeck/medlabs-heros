 ...
 */
public class SecondarySchoolStudent extends IdxStudent
{
    /** */
    private static final long serialVersionUID = 20211001L;

    /**
     * Create a Student with a number of basic properties, including the scool type and school that the student attends. The
     ...
     */
    public SecondarySchoolStudent(final MedlabsModelInterface model, final int id, final boolean genderFemale, final byte age,
            final int homeLocationId, final short weekPatternIndex, final int schoolLocationId)
    {
        super(model, id, genderFemale, age, homeLocationId, weekPatternIndex, schoolLocationId);
    }
