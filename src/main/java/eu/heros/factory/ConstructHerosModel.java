...
public class ConstructHerosModel
{
    ...
    private void readLocationTypeTable() throws Exception
    {
        ...
        if (it.hasNext())
        {
            ...
            while (it.hasNext())
            {
                ...
                // Class<? extends Location> ltClass = (Class<? extends Location>) Class.forName(ltClassName);
            ...
            for (DiseasePhase diseasePhase : disease.getDiseasePhases())
            {
                if (diseasePhase.getName() != "Dead")
                {
                    for (String personType : new String[] { "infant", "kindergarten student", "primary school student",
                            ...
                            "unemployed job-seeker", "weekend worker", "essential worker" })
                    {
                ...
                switch (socialRole)
                {
                    ...
                    case 5:
                        ...
                        person = new CollegeStudent(this.model, personId, genderFemale, age, homeId,
                                (short) this.model.getWeekPatternMap().get("0_Susceptible_college student").getId(), workSchoolId);
                        break;
                    ...
                    case 10:
                        ...
                        person = new WeekendWorker(this.model, personId, genderFemale, age, homeId,
                                (short) this.model.getWeekPatternMap().get("0_Susceptible_weekend worker").getId(), workSchoolId);
                        break;
                    ...
                    case 11:
                        ...
                        person = new EssentialWorker(this.model, personId, genderFemale, age, homeId,
                                (short) this.model.getWeekPatternMap().get("0_Susceptible_essential worker").getId(), workSchoolId);
                        break;
    ...
    private SortedMap<Double, LocationType> resolveLocationTypeChoice(final String types) throws MedlabsException
    {
        ...
        // make sure the last entry has a probability of exact 1.0, give an error if it's more than 0.0001 away
